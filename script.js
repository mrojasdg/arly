document.addEventListener('DOMContentLoaded', () => {
    ...
    const setupAjaxForm = (formId, statusId, endpoint) => {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        status.textContent = result || 'Ocurrió un error.';
    ...
    // Setup all forms
    setupAjaxForm('b2b-form', 'form-status', 'send_b2b.php');
    setupAjaxForm('newsletter-form', 'newsletter-status', 'subscribe.php');
    setupAjaxForm('general-contact-form', 'contact-status', 'send_contact.php');
});
